...
class TestBuiltItTypesFields(object):
...
class TestJsonSchemaDraft4(object):
    ...
    def test_base_field(self):
        ...
        assert fields.BaseField.to_json_schema_draft4() == dict()
        assert base_field.to_json_schema_draft4() == dict()
